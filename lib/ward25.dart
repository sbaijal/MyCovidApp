...
class war25 extends StatelessWidget {
  final String cookie;
  final String doc_name;
  war25(this.cookie, this.doc_name);
  @override
...
class ward25 extends StatefulWidget {
  final String cookie;
  final String doc_name;
  ward25(this.cookie, this.doc_name);
  ListSearchState createState() => ListSearchState();
}

class ListSearchState extends State<ward25> {
  ...
  getwardUsers() async {
    ...
    for (var warddata in response.data["data"]["25"]["patients"]) {
